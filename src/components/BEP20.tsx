  ...
  return (
    <div>
      ...
      <div>
        ...
        <label> AssetAddress: {assetAddress}</label>
        <br />
      ...
      <div>
        ...
        <label>
          BEP20 Address (BEP20):
          <input type="text" value={bep20Address} onChange={(e) => setBep20Address(e.target.value)} />
          <br />
          Amount (BEP20):
      ...
      <br />
      <div>
        Step 3: Withdrawal BEP20 From L2 To L1:
        <br />
        <br />
        <label>
          Amount (BEP20):
